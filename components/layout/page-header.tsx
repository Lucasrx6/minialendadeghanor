  ...
  return (
    <header className={cn("mb-4 space-y-2", className)}>
      {backHref && (
        <Link
          href={backHref}
          className="inline-flex min-h-11 items-center gap-1.5 rounded-lg px-1 text-sm font-bold text-amber-900 hover:bg-amber-900/5 active:bg-amber-900/10 transition"
        >

...
export const STARTER_KITS: Record<ClassId, StarterKit> = {
  ...
  clerigo:   { weapons: ["maca"],         martialWeapons: [],                  armor: "brunea",          heavyArmor: "brunea",   shield: "escudo_leve",  extras: ["simbolo_sagrado"] },
  druida:    { weapons: ["lanca"],        martialWeapons: [],                  armor: "armadura_couro",  shield: "escudo_leve",  extras: ["simbolo_sagrado"] },
  ladino:    { weapons: ["adaga", "espada_curta"], martialWeapons: [],        armor: "couro_batido",    extras: ["ferramentas_ladrao"] },
